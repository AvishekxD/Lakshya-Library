...
export function Safari({
    ...
    return (
        <div
            className={`relative rounded-xl w-full z-10 align-middle leading-none mx-auto max-w-270 ${className ?? ""}`}
            style={{
        ...
        >   
            <div
                className="absolute z-20 flex dark:bg-(--secondary4) dark:rounded-b-xl "
                style={{
                    left: `${LEFT_PCT}%`,
                    top: `${TOP_PCT}%`,
                    width: `${WIDTH_PCT}%`,
            ...
            >
                ...
                >
                    ...
                    <circle
                        ...
                        cy="25"
                        r="6"
                        className="fill-[#E5E5E5] dark:fill-[#404040] hover:fill-[#FF605C]"
                    />
                    <circle
                        cx="47"
                        cy="25"
                        r="6"
                        className="fill-[#E5E5E5] dark:fill-[#404040] hover:fill-[#FFBD44]"
                    />
                    <circle
                        cx="67"
                        cy="25"
                        r="6"
                        className="fill-[#E5E5E5] dark:fill-[#404040] hover:fill-[#00CA4E]"
                    />
                    <path
            ...
            <BorderBeam duration={15} size={250} />
        </div>
    )
}
