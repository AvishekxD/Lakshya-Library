...
export function Iphone({
  ...
  return (
    <div
      className={`relative inline-block w-full z-1 align-middle leading-none ${className}`}
      style={{
      ...
      >
        <g mask={hasMedia ? "url(#screenPunch)" : undefined}>
          ...
          <path
            ...
            className="fill-[#E5E5E5] dark:fill-[#5f5f5f]"
          />
          <path
        ...
        <path
          ...
          className="fill-[#E5E5E5] dark:fill-[#555555]"
        />
        ...
        <path
          ...
          className="fill-[#E5E5E5] stroke-[#E5E5E5] stroke-[0.5] dark:fill-[#2c2c2c] dark:stroke-[#404040]"
